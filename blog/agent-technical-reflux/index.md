# 工程师拥抱 Agent，普通人却重新开始开发软件

作者：杨正武
来源：https://imcoders.cn/blog/agent-technical-reflux/
发布：2026-08-30T00:00:00.000Z
更新：2026-08-30T00:00:00.000Z
...
与此同时，另一批人正在做相反的事情。随着 [千问办公（QwenWork）](https://qwenwork.cn/) 和 [WorkBuddy](https://cloud.tencent.cn/act/pro/workbuddy) 这样的个人 Agent APP 出现，非研发人员也可以用自然语言组织数据、生成文档、分析表格、搭建网页、连接办公工具，逐渐形成自己的个人工作台。

工程师正在尝试绕过一部分传统软件开发，普通人却因为 Agent 第一次拥有了组合软件能力的机会。

**一边是工程师希望把软件变成 Agent，另一边是普通人开始用 Agent 搭建属于自己的软件。**

![工程师在传统企业系统上增加 Agent 层，普通人则用 Agent 组合自己的个人工作台，两条路径围绕同一个 Agent 核心形成技术回流](/blog-images/agent-technical-reflux/hero-technology-reflux.jpg)
...
![千问办公和 WorkBuddy 作为个人 Agent 入口，连接企业聊天、邮件、日历、文档、知识库、数据库、表格、分析与外部云服务](/blog-images/agent-technical-reflux/personal-workbench-connections.jpg)
...
![个人 Agent 工作台通过包含身份、工具、API、审批、审计、安全和回滚能力的受控连接层访问企业系统与外部服务](/blog-images/agent-technical-reflux/governed-connection-layer.jpg)
...
1. **稳定的企业能力层**：保存正式数据、业务规则、权限、状态和审计记录。
2. **个性化的 Agent 工作层**：围绕每个人的目标，理解信息、组合工具并生成交付物。
...
- [千问办公（QwenWork）官网](https://qwenwork.cn/)
- [Anthropic：Building effective agents](https://www.anthropic.com/research/building-effective-agents)
- [腾讯 WorkBuddy](https://cloud.tencent.cn/act/pro/workbuddy)
